...
export default function RandburgPage() {
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.curtainclean.co.za/locations/randburg#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Randburg",
            "item": "https://www.curtainclean.co.za/locations/randburg"
          }
        ]
      },
      {
        "@type": "LocalBusiness",
        "@id": "https://www.curtainclean.co.za/locations/randburg#business",
        "name": "Curtain Cleaning Johannesburg - Randburg",
